...
一些访问方式可见文件 [http/server.http](https://gitee.com/kkbt/obcsapi-go/blob/master/http/server.http)

#### 前端

本地 [http://localhost:8900/](http://localhost:8900/) 或者 [https://note.ftls.xyz/web/](https://note.ftls.xyz/web/)
