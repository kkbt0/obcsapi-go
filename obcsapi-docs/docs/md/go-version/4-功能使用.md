...
文档提供了一个[在线的 API 文档 - Scalar API references](https://kkbt.gitee.io/obcsapi-go/swagger/swagger.html)，可以简单查看下都有什么 API ，以及不同程序语言的请求代码。具体请求头的验证，需要的参数，见 后端程序的 Swagger 或源代码。
